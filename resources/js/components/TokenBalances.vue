...
<script>
    export default {
        props: ['contracts', 'network', 'ethereumPrice'],
        data() {
            return { 
                parsedContracts: []
            }
